...
class Rhombus(Parallelogram):
    ...
    def setSide(self,value):
        assert _isnumber(value), 'not valid value'
...
class Rectangle(Parallelogram):
    ...
    def getFill(self):
        ...
        return self._fill
    def setFill1(self, red, green, blue, alpha):
        assert isinstance(self._fill,colormodel.RGB)
        self._fill.Red= red
        self._fill.Green= green
        self._fill.Blue= blue


    def setFill(self,value):
        assert isinstance(value,colormodel.RGB)
        self._fill = value
